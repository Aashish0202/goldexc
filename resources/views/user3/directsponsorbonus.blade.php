...
<?php
   ...
   ?> 
            ...
            <div class="title-bar">
                        <h5 class="dz-title">Sponcer Bonus Report</h5>                       
                    </div>

                    <div class="list item-list recent-jobs-list">
                        <ul>                         
                         @foreach($booster_data as $booster_data)
                         @if($booster_data['sponcer_income'] !='0')
                            <li>
                                <div class="item-content">
                                    ...
                                    <div class="item-inner">
                                        ...
                                        <div class="d-flex align-items-center mb-2">
                                            ...
                                            <div class="item-price">Sponcer Bonus Income : {{$booster_data['sponcer_income']}}
                                             </div>

                                            <div class="item-price">User_Id : {{$booster_data['user_id']}}
                                             </div>
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="item-price"> User Current Package : {{$booster_data['package']}}  </div>
