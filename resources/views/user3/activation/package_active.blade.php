                                 ...
                                 <form method="post" action="{{url('/')}}/user/package_active_post" enctype="multipart/form-data">
                                  ...
                                  <span style="color: green;" id="success_msg_sponcer"></span></p>  
                                    <div class="mb-3 form-input">
                                        ...
                                        <input  type="text" class="form-control" placeholder="Wallet Balance"name="wallet_balance" id="wallet_balance" value="{{$wallet_balance['activation_wallet']}}TRX" readonly>
                                    </div>
                                  ...
                                  <div class="row mb-3">
                                      ...
                                      <div class="col-sm-9">
                                        <input  type="text" class="form-control" placeholder="Enter package Amount"name="package" id="package" min="200" max="500000" value="200">
                                      </div>
