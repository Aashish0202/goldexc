                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="title">Fund Transfer</h5>
                        </div>
                        <div class="card-body">
                            <div class="basic-form style-1">
                                <form method="post" action="{{url('/')}}/user/fund_transfer_user_post" enctype="multipart/form-data" onsubmit="return checkall()">
                                        @csrf
                                    <div class="mb-3 form-input">
                                        <span class="input-icon">
                                           <i class="fa fa-user"></i>
                                        </span>
                                        <input type="text" class="form-control" placeholder="Wallet Balance" name="wallet_balance" id="wallet_balance" value="{{$wallet_balance['activation_wallet']}}" readonly>
                                    </div>
                                    <div class="mb-3 form-input">
                                        <span class="input-icon">
                                           <i class="fas fa-donate"></i>
                                        </span>
                                        <input type="text" class="form-control" placeholder="Transfer Amount"  name="transfer_amount" id="amount"  onchange="return checkamount()"
                                    ...
                                    <div class="mb-3 form-input">
                                        ...
                                        <input oninput="this.value = this.value.toUpperCase()" type="text" class="form-control" placeholder="Transfer To"  name="transfer_to" id="transfer_to" placeholder="Enter Transfer To" onchange="usertrascheck()" >
                                     ...
                                     <div class="mb-3 form-input">
                                        ...
                                        <input type="text" class="form-control" placeholder="Transaction PIN "  name="tpin" id="tpin" ></p>
                                    </div>
                                    <div class="col-sm-9">
                                                <input type="submit" class="btn btn-primary px-4" id="submit" value="Submit" />                                     
                                            </div>
                                </form>
                            </div>
                        </div>
