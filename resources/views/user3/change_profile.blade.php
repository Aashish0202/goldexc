                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                <form method="post" action="{{url('/')}}/user/change_profile_post" enctype="multipart/form-data"  onsubmit="return checkall()">  
                                        @csrf
                                    <div class="mb-3 form-input">
                                        <span class="input-icon">
                                           <i class="fa fa-user"></i>
                                        </span>
                                        <input type="text" class="form-control" name="first_name" id="first_name" value="{{$user->first_name}}" placeholder="Name">
                                    </div>
                                     <div class="mb-3 form-input">
                                        <span class="input-icon">
                                    ...
                                    <div class="mb-3 form-input">
                                        ...
                                        <input type="number" class="form-control" name="mobile" id="mobile" value="{{$user->mobile}}" placeholder="Mobile">
                                    </div>                                                                 
