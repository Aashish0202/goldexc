                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <h6 class="text-danger">Charges Apply*</h6>
                        </div>
                            ...
                            <div class="basic-form style-1">
                                <form method="post" action="{{url('/')}}/user/payment_withdraw_post" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3 form-input">
                                        ...
                                        <input type="text" class="form-control"name="wallet_balance" id="wallet_balance" value="{{$wallet_balance['wallet_balance']}}TRX" readonly class="text-danger"></p>
                                    </div>
                                    <div class="mb-3 form-input">
                                        <span class="input-icon">
                                        ...
                                        <input type="text" class="form-control" name="transfer_amount" id="transfer_amount" onchange="return checkamount()" 
                                         onkeypress="return /[0-9]/i.test(event.key)"placeholder="Balance To Withdraw">
                                          <p id ="err_transfer_amount" class="font-weight-bold"></p>
                                    </div>
                                    <div class="col-sm-8">
                                                <input type="radio" name="field" value="imps" id="imps" onclick='check_value(this);' @if(empty($user->usdt_address)) disabled  @endif> TRON (TRC20) : {{$user->usdt_address}}  <br/>
                                      </div>
                                         <div class="row mb-5 mt-4">
                                            <div class="col-sm-3">
                                                <h6 class="mb-0">Amount (TRON) :</h6>
                                            </div>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="amount_in_coin" id="amount_in_coin" placeholder="Enter Amount (TRON)" readonly="true"  >
                                            </div>
                                        </div>
