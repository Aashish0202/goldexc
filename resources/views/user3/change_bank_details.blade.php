                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="title">Change TRX (TRC20) Adress</h5>
                        </div>
                        <div class="card-body">
                                ...
                                <form method="post" onsubmit="return checkall()" action="{{url('/')}}/user/change_bank_details_post" enctype="multipart/form-data">
                                   ...
                                   <!--  <div class="mb-3 form-input">
                                    ...
                                    <div class="mb-3 form-input">
                                        ...
                                        <input type="text" class="form-control" placeholder="TRX Address" name="usdt_address" id="usdt_address" value="{{$user->usdt_address}}">
                                    </div>
