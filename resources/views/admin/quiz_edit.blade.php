        ...
        <div class="row">
          ...
          <div class="col-md-8 mt-3">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{url('/')}}/admin/quiz_edit_post" method="post" enctype="multipart/form-data" onsubmit="return checkall()"> @csrf
                ...
                <div class="card-body">
                 ...
                 <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="quation" name="quation" value="{{$data->quation}}">
                  </div>
                 ...
                 <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="option_1" name="option_1" value="{{$data->option_1}}">
                  </div>
                  <div id="site_name_err" class="text-danger"></div>
                </div>
                 ...
                 <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="option_2" name="option_2" value="{{$data->option_2}}">
                  </div>
                  <div id="site_name_err" class="text-danger"></div>
                </div>
                 ...
                 <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="option_3" name="option_3" value="{{$data->option_3}}">
                  </div>
                  <div id="site_name_err" class="text-danger"></div>
                </div>
                 ...
                 <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="option_4" name="option_4" value="{{$data->option_4}}">
                  </div>
                  <div id="site_name_err" class="text-danger"></div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="right_ans" name="right_ans" value="{{$data->right_ans}}">
                  </div>
                  <div id="site_name_err" class="text-danger"></div>
                </div>
                 ...
                 <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <input type="time" class="form-control" id="to_time" name="to_time" value="{{$data->to_time}}">
                  </div>
                  <div id="site_name_err" class="text-danger"></div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="name" class="form-control" id="booking" name="booking" value="{{$data->booking}}">
                  </div>
                  <div id="site_name_err" class="text-danger"></div>
                </div>
                 ...
                 <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="name" class="form-control" id="amount" name="amount" value="{{$data->amount}}">
                  </div>
                  <div id="site_name_err" class="text-danger"></div>
                </div>
