        ...
        <div class="row">
          ...
          <div class="col-md-8 mt-3">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{url('/')}}/admin/quiz_setting_post" method="post" enctype="multipart/form-data" onsubmit="return checkall()"> @csrf
                <div class="card-body">
                  <div class="row">
                 <div class="col-md-12">
                  <div class="form-group">
                    <label for="name">Quiz Amount</label>
                    <input type="text" class="form-control" id="quiz_amount" name="quiz_amount" value="{{$data->quiz_amount}}">
                  </div>
