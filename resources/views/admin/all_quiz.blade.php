...
<body>
  ...
  <div class="container-fluid">
   ...
   <div> <a href="{{url('/')}}/admin/all_quiz"  class="btn btn-danger float-right mb-5 ">Go Back</a></div>   
      ...
      <tbody>
                      ...
                      <tr>
                       ...
                       ?>
                        ...
                        <td><b>{{$value->duration}}</b></td>
                        <td>@if($value->winner == "")
                          <a href=""  ></a>
                         @else
                          <a href=""  class="btn btn-warning"><i class="fa fa-trophy"></i></a>
