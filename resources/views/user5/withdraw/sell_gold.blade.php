                                ...
                                <form method="post" action="{{url('/')}}/user/payment_withdraw_post" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3 form-input">
                                        ...
                                        <input type="text" class="form-control" name="amount_in_coin" id="amount_in_coin" 
                                         placeholder="Amount in USDT" readonly="true">
                                         </p>
                                    </div>
                                    ...
                                    <div class="col-sm-9">
                                        <p class="text-success">The Amount of gold you sell will be credited to your wallet in USDT (BEP20) form</p>
                                        @if($date1 >= $date2 && $date1 <= $date3)

                                        @if($user->usdt_address != '')
                                <input type="submit" class=" btn btn-primary px-4" id="submit" value="Withdraw" />
                                        @else
                                        <p class="text-danger">Please Update USDT (BEP20) Address In your Profile</p>
                                        @endif
                                        @else
...
<script language='JavaScript' type='text/javascript'>
 ...
 <script>
   ...
   //Multiple of Condition
      ...
      document.getElementById('amount_in_coin').value = transfer_amount.value * {{$data_setting->currency}};
    }
