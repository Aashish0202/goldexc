                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <h6 class="text-danger">0% Charges</h6>
                        </div>
                        <div class="card-body">
                            <div class="basic-form style-1">
                                 <form method="post" action="{{url('/')}}/user/internal_transfer_post" enctype="multipart/form-data">
                                        @csrf
                                    ...
                                    <div class="mb-3 form-input">
                                        ...
                                        <input type="text" class="form-control" placeholder="Transfer Amount Wallet Balance" name="transfer_amount" id="amount" class="form-control" onchange="return checkamount()"
