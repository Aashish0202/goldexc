        ...
        <div class="container fb">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="title">Deposit Gold from DIGIGOLD</h5>
                        </div>
                        <div class="card-body">
         ...
         <!-- <p style="font-size:12px;"><b>USDT (TRC20) Deposit Address</b> : 
              <span id="p3"> TGoca7iHzHu55XY4uAMLaHLdND5gcVNPcs <i onclick="copyToClipboard('#p3')" class="fa fa-copy" style="color:red;    padding-left: 1%;"></i> </span> </p> -->     
                                  <p>Note:- Send Exact amount of gold</p>                        
                                            </div>
                                    ...
                                    <div class="mb-3 form-input">
                                        ...
                                        <input type="text" class="form-control" placeholder="Amount To Pay"  name="amount_in_coin" id="amount_in_coin" readonly>
                                    </div>
                                    ...
                                    <div class="mb-3 form-input">
                                        ...
                                        <input type="text" class="form-control" placeholder="Mobile Number/Transaction ID/Order ID" name="utr" id="utr">
                                    </div>
...
<script language='JavaScript' type='text/javascript'>
    ...
    function check_value(payment_mode)
    {
       ...
       if(payment_mode.value == "USDT")
      {
         ...
         document.getElementById('amount_in_coin').value = amount*64.89;   
