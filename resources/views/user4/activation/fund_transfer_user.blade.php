          ...
          <div class="row heading-bg">
            ...
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
              <ol class="breadcrumb">
                ...
                <li class="active"><span>Fund Transfer</span></li>
              </ol>
            </div>
            <!-- /Breadcrumb -->
            ...
            <div class="col-md-6">
              <div class="panel panel-default card-view">
                <div class="panel-heading">
                  <div class="pull-left">
                    <h6 class="panel-title txt-dark">Fund Transfer</h6>
                  </div>
                  ...
                  <div class="panel-body">
                    <div class="row">
                      <div class="col-sm-12 col-xs-12">
                        <div class="form-wrap">
                          <form class="form-horizontal" action="{{url('/')}}/user/fund_transfer_user_post" method="post" onsubmit="return checkall()">
                             @csrf
                            ...
                            <div class="form-group">
                              <label for="exampleInputEmail_4" class="col-sm-3 control-label">Transfer Amount</label>
                              <div class="col-sm-9">
                                <div class="input-group">
                            ...
                            <div class="form-group">
                              <label for="exampleInputweb_41" class="col-sm-3 control-label">Transfer To</label>
                              <div class="col-sm-9">
                                <div class="input-group">
