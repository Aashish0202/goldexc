  ...
  <span class="tooltiptext">Tooltip text</span>
      ...
      @if($user->is_active == "active")
        @if($user->is_active_10 == "active")
         <a data-toggle="tooltip" data-placement="top" title="{{$user->first_name}} | {{$user->mobile}} | {{$user->is_active_10}}" href="#" style ="background-color:yellow; color:#fff;"><img src="{{url('/')}}/public/profile_image/user_tree.png" style="height:25px;width: 30px"> 
      ...
      <ul>
        ...
        <li>
           ...
           @if($value->is_active_10 == "active")
            ...
            <a  data-toggle="tooltip" data-placement="top" title="{{$value->first_name}} {{$value->mobile}}"  href="{{url('/')}}/user/tree_view?user_id={{$value->email}}" style ="background-color:yellow; color:#fff;"><b>{{$value->email}}</b></a>
        ...
        @endif
          ...
          @foreach($sponcer2_data as $key1=>$value1)
            <li>
              ...
              <a data-toggle="tooltip" data-placement="top" title="{{$value1->first_name}} {{$value1->mobile}}" href="{{url('/')}}/user/tree_view?user_id={{$value1->email}}" style ="background-color:yellow; color:#fff;">{{$value1->email}}</a>
              @else
          ...
          @foreach($sponcer3_data as $key2=>$value2)
            <li>
              ...
              <a data-toggle="tooltip" data-placement="top" title="{{$value2->first_name}} {{$value2->mobile}}" href="{{url('/')}}/user/tree_view?user_id={{$value2->email}}" style ="background-color:yellow; color:#fff;">{{$value2->email}}</a>
              @else
