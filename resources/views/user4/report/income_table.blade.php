                ...
                <div class="row heading-bg">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                      <ol class="breadcrumb">
                        ...
                        <li class="active"><span>@if(isset($_GET['title'])){{$_GET['title']}}@endif</span></li>
                      </ol>
                    </div>
                    <!-- /Breadcrumb -->
                </div>
                    ...
                    <div class="col-sm-12">
                        <div class="panel panel-default card-view">
                            <div class="panel-heading">
                                <div class="pull-left">
                                    <h6 class="panel-title txt-dark">@if(isset($_GET['title'])){{$_GET['title']}}@endif</h6>
                                </div>
                                        ...
                                        <div class="table-responsive">
                                            <table id="datable_1" class="table table-hover display  pb-30" >
                                             ...
                                             <?php  $user = Sentinel::check();
                                                   $total_direct = DB::table('users')->where('sponcer_id','=',$user->email)->count(); ?>
                                               ...
                                               <tr> 
                                                  ...
                                                  <td>{{$data->income}}</td>
                                                  <td>{{$data->days}}</td>
                                                  <td>{{$data->total}} USDT</td>
                                                  
                                                  @if($total_direct == $data->member)
                                                  <td class="text-success">Acheived</td>
                                                  @else
                                                  <td class="text-danger">Not Achived</td>
                                                  @endif
