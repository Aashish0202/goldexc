...
<head>
    ...
    *===========================-->
    ...
    <!--=========================*
              Page Title
    *===========================-->
    <title>{{$data_setting->site_name}} | Dashboard</title>
    ...
    <div class="header-area">
        ...
        *=========================-->
        <div class="header-area-left">
            ...
            <a href="" class="logo">
                <span>
                    <img src="{{url('/')}}/public/site_logo/{{$logo->site_logo}}" alt="" height="10" class="mt-3" style="height: 80px;width: 80px">
                </span>
                <i>
                    ...
                    <li id="full-view-exit" class="d_none_sm"><i class="fa fa-arrows-alt"></i></li>
                        ...
                        <div class="dropdown">
                            <button class="btn dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                @else
                                      <img src="{{url('/')}}/public/profile_image/user2.jpg" alt="" class="img-fluid">
                                @endif
                            </button>
