...
class ZowalletController extends Controller
{
                                  
     public function iniate_transfer($api_token, $user_full_name, $bank_account_no, $ifsc, $amount, $mobile)
      {
    ...
    //  print_r( $data_setting->uk18_key); die();
        ...
        $url = 'https://zozowallet.com/api/payout/transfer?api_token=z7wNQ8drODQBQ9LtGJNDzbPqPpeAE1AgKviIkTNUyyevW629CBdVKimZDern&beneficiary_name=beneficiary_name&account_number=account_number&ifsc=ifsc&mobile_number=mobile_number&amount=amount&client_id=client_id';
        $ch = curl_init($url);
